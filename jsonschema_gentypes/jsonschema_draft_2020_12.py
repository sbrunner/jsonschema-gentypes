...
$vocabulary:
  ...
  https://json-schema.org/draft/2020-12/vocab/validation: true
$comment: This meta-schema also defines keywords that have appeared in previous drafts in order to prevent incompatible extensions as they remain in common use.
Subtype: "CoreVocabularyMetaSchema", "ApplicatorVocabularyMetaSchema", "UnevaluatedApplicatorVocabularyMetaSchema", "ValidationVocabularyMetaSchema", "MetaDataVocabularyMetaSchema", "FormatVocabularyMetaSchemaForAnnotationResults", "ContentVocabularyMetaSchema"
"""
...
r""" Default value of the field path 'Applicator vocabulary meta-schema object dependentSchemas' """
...
r""" Default value of the field path 'Core and Validation specifications meta-schema object dependencies' """


_CORE_AND_VALIDATION_SPECIFICATIONS_META_SCHEMA_OBJECT_DEPENDENTSCHEMAS_DEFAULT: dict[str, Any] = {}
r""" Default value of the field path 'Core and Validation specifications meta-schema object dependentSchemas' """
...
_CoreAndValidationSpecificationsMetaSchemaObject = TypedDict(
    "_CoreAndValidationSpecificationsMetaSchemaObject",
    {
        ...
        # | $comment: This meta-schema also defines keywords that have appeared in previous drafts in order to prevent incompatible extensions as they remain in common use.
        # | Subtype: "CoreVocabularyMetaSchema", "ApplicatorVocabularyMetaSchema", "UnevaluatedApplicatorVocabularyMetaSchema", "ValidationVocabularyMetaSchema", "MetaDataVocabularyMetaSchema", "FormatVocabularyMetaSchemaForAnnotationResults", "ContentVocabularyMetaSchema"
        "items": "CoreAndValidationSpecificationsMetaSchema",
        # | Core and Validation specifications meta-schema.
        # |
        # | $vocabulary:
        # |   https://json-schema.org/draft/2020-12/vocab/applicator: true
